...
function run() {
    ...
    group1.add(new Employee("0101", "支部長"));

    const group2 = new Group("11", "横浜営業所");
    group2.add(new Employee("0101", "営業部長"));
    group2.add(new Employee("0102", "Yamada"));
    group2.add(new Employee("0103", "Suzuki"));
    group2.add(new Employee("0104", "Tanaka"));
